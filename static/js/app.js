...
import { analyzeWithPhi3 } from "./phi3-service.js"; // ✅ Added
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  elements.startLiveBtn.onclick = async () => {
    ...
    elements.livePhiAnalysis.style.display = "none"; // ✅ Hide PHI analysis too
  ...
  elements.captureBtn.onclick = async () => {
    ...
    try {
      ...
      // Run PHI text analysis
      const phiData = await analyzeWithPhi3(blob);
      ...
      elements.liveFullFrame.style.display = "block";
      ...
      // ✅ Show PHI acne analysis
      const phiText = phiData?.phi_analysis || phiData?.analysis || "No PHI response.";
      elements.phiAnalysisOutput.innerText = phiText;
      elements.livePhiAnalysis.style.display = "block";
